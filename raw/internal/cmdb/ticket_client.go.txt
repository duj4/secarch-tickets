...
var (
	ErrTicketNotFound = errors.New("CMDB ticket not found")
...
func (c *Client) GetTicket(ctx context.Context, ticketNumber string) (*Ticket, error) {
	...
	for issueKey, issue := range resp.Issues {
		return normalizeTicket(issueKey, issue)
	}
	return nil, fmt.Errorf("%w: %s", ErrTicketNotFound, ticketNumber)
}
...
func (c *Client) fetchTicketPage(ctx context.Context, jql string, startAt int) (*TicketQueueAPIResponse, error) {
	...
	return c.fetchTicketRequest(ctx, requestURL)
}

func (c *Client) fetchTicketByKey(ctx context.Context, ticketNumber string) (*TicketQueueAPIResponse, error) {
	requestURL, err := c.buildTicketByKeyRequestURL(ticketNumber)
	if err != nil {
		return nil, err
	}
	return c.fetchTicketRequest(ctx, requestURL)
...
func (c *Client) fetchTicketRequest(ctx context.Context, requestURL string) (*TicketQueueAPIResponse, error) {
...
func (c *Client) buildTicketByKeyRequestURL(ticketNumber string) (string, error) {
...
func normalizeTicket(issueKey string, issue TicketQueueAPIResponseIssue) (*Ticket, error) {
	...
	systemNames := issue.CMDBSystemName
	if system.Name != "" {
		systemNames = []string{system.Name}
	}
